...
| Desired safety buffer (%) | 25% |
| **Freedom Number** (expenses × 1.25) | **$** |
| Target MRR before quitting (Freedom Number × 1.5) | $ |
| Emergency runway target (months of expenses in cash) | 12 |

**Rule:** You do not resign until your side-business MRR has covered your Freedom Number for **6 consecutive months** AND you hold 12 months of runway in cash.

Calculate yours automatically: https://invisibleexit.com/tools/freedom-calculator
...
- [ ] I have read my employment contract for non-compete, IP-assignment, and moonlighting clauses
- [ ] I never work on the business using employer equipment, network, or accounts
- [ ] I never work on the business during compensated hours
- [ ] The business does not compete with my employer and uses zero employer confidential information
- [ ] My name does not appear on the website, domain WHOIS, social accounts, or marketing
- [ ] Payments route through a legal entity, not my personal name
- [ ] I know my state/country's rules on side businesses and IP assignment

Scan your contract in 60 seconds: https://invisibleexit.com/tools/non-compete-scanner
...
**Entry criteria:** Stealth Rules checklist above is 100% complete.

- [ ] Form an anonymous-friendly legal entity (e.g. LLC with registered agent)
- [ ] Business bank account + payment processor under the entity
- [ ] Faceless brand: name, logo, domain with WHOIS privacy
...
- [ ] Ship one retention improvement per month (churn < 5%)
- [ ] Raise prices once (most underpriced founders can raise 30–50%)
- [ ] Automate onboarding + support so the business runs on 10 hrs/week
...
**You are no longer an employee with a side project. You are a founder who used to have a job.**
...
**The one-question audit:** "If my employer searched for this business tonight, would they find me?" If the answer is anything but a confident *no*, fix that before doing anything else this week.
...
Scoring guide: Demand 40 pts · Willingness-to-pay 25 pts · Low competition 20 pts · Buildability 15 pts. **Build nothing under 60.**
