...
const CATEGORIES = [
  ...
  },
  {
    icon: Calculator,
    title: "Cost Analysis",
    description: "11 pages. Realistic cost breakdowns for starting and running a micro-SaaS. Know exactly where every dollar goes.",
    link: "/cost-analysis",
    linkLabel: "Browse Cost Guides",
    count: "11 pages",
  },
  {
    icon: BookOpen,
    title: "How-To Guides",
    description: "12 step-by-step playbooks for building a micro-SaaS while employed. Each with tools, timelines, and mistakes to avoid.",
    link: "/how-to",
    linkLabel: "Browse How-To Guides",
    count: "12 guides",
  },
  {
    icon: Globe,
    title: "Legal Concerns",
    description: "13 pages answering the legal questions employed founders ask. Non-competes, IP assignment, moonlighting rules.",
    link: "/is-it-legal",
    linkLabel: "Browse Legal Guides",
    count: "13 pages",
  },
  {
    icon: BookOpen,
