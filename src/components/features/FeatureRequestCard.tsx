...
export default function FeatureRequestCard({
  ...
  return (
    <div className="flex gap-3 sm:gap-4 rounded-xl bg-white border border-gray-200 p-4 transition-colors hover:shadow-md">
      {/* Vote controls */}
      <div className="flex flex-col items-center gap-0.5 min-w-[40px]">
        ...
        />
        <span className="text-sm font-semibold text-[#0B1D3A] tabular-nums">
          {feature.vote_count}
        </span>
        <VoteButton
          direction="down"
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-start justify-between gap-2 mb-1">
          <h3 className="text-[#0B1D3A] font-semibold text-sm sm:text-base leading-snug">
            {feature.title}
          </h3>
