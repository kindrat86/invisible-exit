...
export const bestToolsLists: BestToolsList[] = [
  ...
  },
  {
    ...
    tools: [
      ...
      { name: "Invisible Exit", url: "https://invisibleexit.com", pricing: "$9/month (founding)", bestFor: "Scripts, hooks, and distribution strategy for faceless channels", pros: ["50+ tested YouTube hooks", "Reddit + blog repurposing playbooks", "Faceless content calendar", "One-video-to-one-week system"], cons: ["Membership, not a production tool", "Geared toward employed founders building SaaS audience"], rating: 5 },
    ],
