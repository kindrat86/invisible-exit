/**
 * Language configuration — 97 supported languages, alphabetically sorted by English name.
 * Each language has: URL path segment, BCP 47 hreflang tag, English name,
 * native name (autonym), ISO code, RTL flag, and emoji flag.
 *
 * The 4 dialect variants Google Translate does not support have been removed:
 *   - Hakka Chinese (hak), Min Nan (nan), Wu Chinese (wuu), Nigerian Pidgin (pcm)
 * Adding a paid Google Cloud Translate API key would re-enable them.
 */
...
export const LANGUAGES: Language[] = [
  ...
  { code: "ky", hreflang: "ky", name: "Kyrgyz", nativeName: "Кыргызча", iso: "ky", rtl: false, flag: "🇰🇬" },
  { code: "lo", hreflang: "lo", name: "Lao", nativeName: "ລາວ", iso: "lo", rtl: false, flag: "🇱🇦" },
  { code: "la", hreflang: "la", name: "Latin", nativeName: "Latina", iso: "la", rtl: false, flag: "🇻🇦" },
  ...
  { code: "mi", hreflang: "mi", name: "Maori", nativeName: "Māori", iso: "mi", rtl: false, flag: "🇳🇿" },
