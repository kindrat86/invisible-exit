...
import { shouldNoindex } from "../src/data/noindex-config.ts";
...
function getRoutes() {
  ...
  routes.push({
    path: "/",
    meta: {
      title: "Faceless Side Business Without Quitting | Invisible Exit",
      description:
      ...
      // canonical @id-keyed homepage graph (Organization, WebSite,
      // WebApplication, FAQPage, SoftwareApplication) and is deliberately
      // preserved on this route by the strip below. Emitting a second set
      // here gave the homepage duplicate conflicting entities. The 8 FAQ
      // questions unique to this block were merged into index.html.
    },
  });
      ...
      jsonLd: [
        {
          ...
          provider: { "@type": "Person", name: "Adrian", url: `${SITE}/adrian`, image: `${SITE}/adrian-avatar.svg` },
        ...
        jsonLd: [
          {
            ...
            author: { "@type": "Person", name: "Adrian", url: SITE, image: `${SITE}/adrian-avatar.svg` },
            publisher: { "@type": "Organization", name: SITE_NAME, url: SITE },
            ...
            itemListElement: list.tools.map((t, i) => ({
              ...
              item: {
                ...
                review: {
                  ...
                  author: { "@type": "Person", name: "Adrian", image: `${SITE}/adrian-avatar.svg` },
