# AI Directory Submission Data: InvisibleExit

Prepared 2026-07-19. Use these for manual submissions (CAPTCHA required on all).

## Free Directories

### 1. SaaS AI Tools (saasaitools.com)
**Submit URL:** https://saasaitools.com/submit-listing-2/
**Cost:** FREE
**Data:**
- Name: InvisibleExit
...
**Cost:** FREE (verify during submission)
**Data:** Same as above + Chinese market tags: 匿名创业, 副业, 微SaaS

## Paid Directories

### 3. There's An AI For That (theresanaiforthat.com)
**Submit URL:** https://theresanaiforthat.com/launch/
**Cost:** One-time fee (amount not disclosed on landing page)
**Note:** Requires account creation. Previous listings get placed within 1 day.

### 4. Futurepedia.io
**Submit URL:** https://www.futurepedia.io/submit-tool
**Cost:** $247 Basic (Sold Out as of 2026-07-19), $497 Verified (one-time)
**Verdict:** Skip unless proof of ROI from other directories.
